...
```
   ...
   2,30 м ─┬──────────  верх рейки
           │
   2,28 м ─┼──┐  верхняя консоль 160 мм → кронштейн проектора
           │  └──▐▌ проектор объективом вниз, дном к стене
   2,25 м ─●     анкер 3
           │
   1,75 м ─●     анкер 2
           │
   1,52 м ─┼────────────┐  нижняя консоль 450 мм
           │            ▀  датчик, ось на 413 мм от стены
   1,25 м ─●     анкер 1
   1,20 м ─┴  низ рейки
```
...
|---|---|---|
| Рейка | стальной профиль 40 × 40 × 2 мм, порошковая окраска, с приваренными ушками под анкеры | длина 1100 мм, низ на 1,20 м, верх на 2,30 м; три точки на 1,25 / 1,75 / 2,25 м |
...
| Страховка | стальной тросик 2 мм с карабином от корпуса проектора к анкеру 3 | обязательно над зоной детей |
...
- По рейке: канал 40 × 25 мм с крышкой, от 2,30 м до пола, крепится к стене
  рядом с рейкой (не к самой рейке, чтобы не мешать регулировке). Внутри:
