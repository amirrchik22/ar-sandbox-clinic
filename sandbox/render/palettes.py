...
PALETTES: dict[str, list[tuple[float, tuple[int, int, int]]]] = {
    ...
    # топографическая шкала, проверенная живьём на песке 23.09: вода — отмель —
    # песок берега — луг — холмы — камень — снег. Переходы плавные, без полос.
    "topo": [(0.00, (16, 56, 110)), (0.13, (31, 111, 168)), (0.26, (73, 168, 192)),
             (0.36, (166, 199, 186)), (0.44, (216, 203, 152)), (0.56, (96, 150, 82)),
             (0.68, (150, 160, 72)), (0.80, (166, 128, 74)), (0.91, (138, 128, 120)),
             (1.00, (244, 246, 248))],
}

# Названия для пульта: специалист видит слова, а не ключи.
...
# Порядок кнопок на пульте: сначала три основные.
PALETTE_ORDER: list[str] = ["calm", "classic", "contrast", "topo", "mono"]
